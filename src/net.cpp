...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CosineCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cosinecointools.com", "dnsseed.cosinecointools.com"},
    {"cosinecoinpool.org", "dnsseed.cosinecoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"cosinecointools.com", "testnet-seed.cosinecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CosineCoin is probably already running."), addrBind.ToString().c_str());
        else
