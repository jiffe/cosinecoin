...
uint256 hashGenesisBlock("0x1ed63d92663baeb5818699bd57efd23a4b96aa0426431b332602a49ead257bd3");
...
const string strMessageMagic = "CosineCoin Signed Message:\n";
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const {
    ...
    // CosineCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("76a91470c4ddd5bcce68cdd18d80639cda500da9dd399c88ac") << OP_CHECKSIG;
        CBlock block;
        ...
        assert(block.hashMerkleRoot == uint256("0x58f028dfc13cfedcd8fc62f4215296fe2941e7fd5514d41bb6045551c0e4c511"));
...
unsigned char pchMessageStart[4] = { 0xfc, 0xd0, 0xc1, 0xee };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey) {
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CosineCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CosineCoinMiner : ProcessBlock, block not accepted");
    }
...
void static CosineCoinMiner(CWallet *pwallet) {
    ...
    try { loop {
        ...
        printf("Running CosineCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("CosineCoinMiner terminated\n");
        throw;
    }
}
